...
public class ServerFacade {
    ...
    private static final String SERVER_URL = "https://4arcdxhcji.execute-api.us-west-1.amazonaws.com/Prod";
    ...
    public FollowResponse follow(FollowRequest request, String followUrlPath) throws IOException, TweeterRemoteException{
        return clientCommunicator.doPost(followUrlPath, request, null, FollowResponse.class);
    }
    ...
    public FeedResponse getFeed(FeedRequest request, String getFeedUrlPath) throws IOException, TweeterRemoteException{
        return clientCommunicator.doPost(getFeedUrlPath, request, null, FeedResponse.class);
    }
    ...
    public FollowersCountResponse getFollowerCount(FollowersCountRequest request, String urlPath) throws IOException, TweeterRemoteException{
